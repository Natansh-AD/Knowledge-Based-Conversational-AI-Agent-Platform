# Generated by Django 6.0.2 on 2026-03-06 07:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.IntegerField(blank=True, choices=[(1, 'Admin'), (2, 'Member')], default=2, null=True, verbose_name='type')),
            ...
            bases=(models.Model, users.constants.UserConstants),
            managers=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.IntegerField(blank=True, choices=[(1, 'Admin'), (2, 'Member')], default=2, null=True, verbose_name='role')),
                ...
                ('tenant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invites', to='core.organization')),
            ],
            options={
                'unique_together': {('tenant', 'email')},
            },
            bases=(models.Model, users.constants.InviteConstants),
        ),
    ]
